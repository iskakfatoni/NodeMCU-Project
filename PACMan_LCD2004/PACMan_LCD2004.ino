...
#define I2C_ADDR    0x27  // Get the I2C address. I used I2C Scanner to find this 
                          // (http://playground.arduino.cc/Main/I2cScanner)

// These are the values for the SainSmart 20x4 LCD. Yours may vary.
...
void setup() {
    // Start the LCD up - you can replace this with your screen size
    lcd.autoAddress();
    lcd.begin();
    lcd.clear();
    ...
    //lcd.print("  I am out of the");
    lcd.print(" Saya sedang sibuk!");
    lcd.setCursor(0,message_row_2);
    //lcd.print("  office right now");
    lcd.print("   M. ISKAK FATONI ");
